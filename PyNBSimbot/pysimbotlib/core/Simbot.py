        ...
        if self.iteration == 0:
            ...
            if self.iteration == self.max_tick:
                ...
                if self.save_wasd_history:
                    ...
                    #with open('historyall.csv', 'a', newline='') as out_file:
...
class PySimbotMap(Widget):
    ...
    def _on_keyboard_down(self, keyboard, keycode, text, modifiers):
        ...
        if keycode[1] == 'n':
            ...
            path(r,0,5)
        # Edit new button
        elif keycode[1] == 'f' and self.enable_wasd_control:
            r = self.simbot.robots[0]         
            a = int(r.smell())
            if a >= 0:
                pass
            ...
            for i in range(int(a/5)):
                ...
                r.turn(5)
            r.move(0)
        elif keycode[1] == 'r' and self.enable_wasd_control:
            r = self.simbot.robots[0]
            self.simbot.add_history(r, 5, 5)
            r.turn(5)
            r.move(5)
